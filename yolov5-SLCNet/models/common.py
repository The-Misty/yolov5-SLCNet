...
NET_CONFIG = {
    ...
    "blocks3": [[3, 32, 64, 2, False], [3, 64, 64, 1, False]],
    "blocks4": [[3, 64, 128, 2, False], [3, 128, 128, 1, False]],
    "blocks5": [[3, 128, 256, 2, False], [3, 256, 256, 1, False],
                [3, 256, 256, 1, False], [3, 256, 256, 1, False],
                [3, 256, 256, 1, False], [3, 256, 256, 1, False]],
    "blocks6": [[3, 256, 512, 2, True], [3, 512, 512, 1, True]]
}
BLOCK_LIST = ["blocks2", "blocks3", "blocks4", "blocks5", "blocks6"]
...
class LC_Conv(nn.Module):
    def __init__(self, scale):
        super(LC_Conv, self).__init__()
        self.scale = scale
        self.conv = nn.Conv2d(3, out_channels=make_divisible_LC(16 * self.scale),
                              kernel_size=3, stride=2, padding=1, bias=False)
